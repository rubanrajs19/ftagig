...
<section class="tabs-container">
  ...
  <?php
  // Build category ID => slug/type map
  $categoryMeta = [];
  foreach (array_merge($individual_categories, $bundle_categories) as $cat) {
      $categoryMeta[$cat['id']] = [
          'slug' => $cat['slug'],
          'type' => $cat['type']
      ];
              ...
              <div class="plan-card">
                  ...
                  <div class="ideal-for">
                   ...
                   <div class="row g-2">
                    <div class="col">
                      <?php
                      $catInfo = $categoryMeta[$svc['category_id']] ?? ['slug' => 'unknown', 'type' => 'bundle'];
                      ?>
                      <a href="<?= base_url($catInfo['type'] . '/' . $catInfo['slug'] . '/' . $svc['slug']) ?>" class="btn btn-know-more">Know More</a>
